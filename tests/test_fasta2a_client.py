...
def print_troubleshooting():
    ...
    print("   - Make sure Pyraclaw is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Pyraclaw server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Pyraclaw server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Pyraclaw server if not running")
