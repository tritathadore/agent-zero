...
class PyraclawWorker(Worker):  # type: ignore[misc]
    """Pyraclaw implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through Pyraclaw."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to Pyraclaw format
            ...
            # Process message through Pyraclaw (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to Pyraclaw UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                "organization": "Pyraclaw",
                "url": "https://github.com/frdel/pyraclaw"
            }
            ...
            self._worker = PyraclawWorker(broker=broker, storage=storage)  # type: ignore[attr-defined]
